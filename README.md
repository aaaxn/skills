...
| [`merge`](./merge/) | Merge a PR with easy, adaptive, or full verification | Maintained in this repository |
| [`ship`](./ship/) | Commit, push, and open a PR with easy, adaptive, or full verification | Maintained in this repository |
...
The locally maintained `ruff` and `sync-experiments` skills are installed
